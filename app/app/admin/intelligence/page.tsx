...
export default async function FounderIntelligencePage() {
  ...
  return <main className="container founder-shell">
    ...
    <section className="card founder-panel founder-secondary">
      ...
      <div className="action-row"><Link className="btn btn-secondary button-link" href="/app/admin/operations">Operations</Link><Link className="btn btn-secondary button-link" href="/app/admin/audit">Audit</Link><Link className="btn btn-secondary button-link" href="/app/admin">Admin home</Link></div>
    </section>
  </main>
}
